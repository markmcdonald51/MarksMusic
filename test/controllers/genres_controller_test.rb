...
class GenresControllerTest < ActionController::TestCase
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post :create, genre: { description: @genre.description, name: @genre.name, parent_id: @genre.parent_id }
    end
  ...
  test "should update genre" do
    patch :update, id: @genre, genre: { description: @genre.description, name: @genre.name, parent_id: @genre.parent_id }
    assert_redirected_to genre_path(assigns(:genre))
  end
